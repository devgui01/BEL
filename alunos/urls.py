...
urlpatterns = [
    ...
    path('mensalidades/registrar/<int:pk>/', views.registrar_pagamento, name='registrar-pagamento'),
    ...
    path('mensalidades/editar/<int:pk>/', views.editar_mensalidade, name='editar-mensalidade'),
] 